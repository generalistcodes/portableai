...
Then open **http://localhost:5050**. You get:
...
itself), then starts the server on `http://localhost:5050`. No shell
scripts, no `venv\Scripts\activate` vs `source venv/bin/activate`
